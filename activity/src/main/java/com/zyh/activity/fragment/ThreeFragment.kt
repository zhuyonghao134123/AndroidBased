...
class ThreeFragment : Fragment() {
    ...
    private var listener: OnThreeFragmentInteractionListener? = null
    ...
    fun onButtonPressed(uri: Uri) {
        listener?.onThreeFragmentInteraction(uri)
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is OnThreeFragmentInteractionListener) {
            listener = context
        } else {
     ...
     */
    interface OnThreeFragmentInteractionListener {
        // TODO: Update argument type and name
        fun onThreeFragmentInteraction(uri: Uri)
    }
